...
- Unzip the file to a folder on your computer (e.g., `Desktop/crypto-app-main`).
- Open Command Prompt/Terminal and navigate to the folder:
  ```bash
  cd Desktop/crypto-app-main
  ```
...
- In Command Prompt/Terminal, type:
  ```bash
  git clone https://github.com/m01n008/crypto-app.git
  cd crypto-app-main
  ```


### 3. Set Up the App
- In Command Prompt/Terminal, while in the `crypto-app-main` folder, type:
  ```bash
  npm install
  ```
...
## License
This project is shared under the [MIT License](LICENSE) (or contact the me for details).
